/* ==========================================================================
   APEX CONSTRUCTION — Main JavaScript
...
(function () {
  ...
  document.querySelectorAll('.portfolio__view-btn').forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      document.getElementById('lightboxDesc').textContent = project.desc;
  ...
  document.getElementById('lightboxCta').addEventListener('click', function () {
    closeLightbox();
  });
  ...
  bidForm.addEventListener('submit', function (e) {
    ...
    var formData = {
      ...
      contactMethod: bidForm.querySelector('[name="contactMethod"]:checked').value,
  ...
  // Allow Enter/Space on portfolio view buttons
  document.querySelectorAll('.portfolio__view-btn').forEach(function (btn) {
